...
% sapper & svelte -- connection
% ajax/server rendered
% samma kod kan köras på både server och klient
% anledning till val: bind:<sak>={<var>}
% kort snutt av exemepel
